...
export default function User({ data }) {
  ...
  return (
    <>
      {open && (
        <div className="absolute z-10 flex w-full h-fulll justify-center items-center top-[50%] -translate-y-[50%] left-0 text-black">
          <div className="relative w-[90%] h-[90%] bg-white rounded-xl p-4 pb-12">
            <button
